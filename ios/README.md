...
- BLE Scanner (CoreBluetooth): advertised name, identifier, RSSI, SIG manufacturer company ID, connectable, service-data UUIDs, kind hints, and a live radar layout (RSSI distance estimate; angle is layout, not bearing). Device count ≠ people.
