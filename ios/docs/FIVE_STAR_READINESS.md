...
- [ ] Do not bump marketing version just to spam uploads. **1.0 is approved and closed** — the next train must be **1.0.1** / `CURRENT_PROJECT_VERSION` **≥123**. Do not retry **1.0 (121)**.
