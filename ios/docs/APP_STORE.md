...
**SKU:** `beckify-toolbox`  
**Connect status:** **1.0 approved** (train closed). Next version **1.0.1** (create or select in Connect before upload); next binary **1.0.1 (122)**  
...
| Binary | 1.0 approved; 1.0 (113) was rejected by Review (Guideline 2.1, 2026-09-09); 1.0 (121) rejected by Transporter (ITMS-90186 / ITMS-90062). Next upload **1.0.1 (122)** |
| App ID (Apple ID) | `6807908745` |
| Bundle ID | `com.beckify.toolbox` |
| SKU | `beckify-toolbox` |
