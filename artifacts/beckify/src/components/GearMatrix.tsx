...
const gear: Gear[] = [
  { category: "Precision hand tools", name: "Daniels Manufacturing AF8", model: "M22520/1-01 / AS22520/1 crimp frame", bestFor: "Qualified machined-contact crimping when paired with the correct approved turret or positioner.", note: "The frame alone is not a universal crimp solution; the contact family, turret, setting, and work instruction control the finished result.", retailerQuery: "Daniels Manufacturing AF8 M22520/1-01 crimp tool", manufacturerUrl: "https://dmctools.com/af8-af8", purchasePath: "Amazon" },
  { category: "Precision hand tools", name: "Daniels Manufacturing HX4", model: "M22520/5-01 open-frame crimp tool", bestFor: "Interchangeable-die crimping for contacts, coax, shield ferrules, terminals, and splices.", note: "Use only the die and locator combination specified for the exact termination system.", retailerQuery: "Daniels Manufacturing HX4 M22520/5-01 crimp tool", manufacturerUrl: "https://dmctools.com/hx4", purchasePath: "Amazon" },
  { category: "Precision hand tools", name: "Wera 1460 ESD Kraftform Micro", model: "Preset ESD-safe micro torque screwdriver", bestFor: "Controlled torque on fine connector and electronics hardware where over-torque or electrostatic discharge is a risk.", note: "Match the torque value and bit system to the fastener and approved assembly procedure.", retailerQuery: "Wera 1460 ESD Kraftform Micro torque screwdriver", manufacturerUrl: "https://www.wera.de/en/tools/1460-esd-kraftform-micro-torque-screwdrivers-with-factory-pre-set-value-002-011-nm-and-quick-release-chuck", purchasePath: "Amazon" },
  { category: "Precision hand tools", name: "KNIPEX EvoStrip", model: "Automatic wire stripper", bestFor: "Repeatable wire preparation for solid, stranded, and finely stranded conductors within its specified range.", note: "Confirm conductor size, insulation type, and strip length against the work package before relying on an automatic setting.", retailerQuery: "KNIPEX EvoStrip automatic wire stripper", manufacturerUrl: "https://www.knipex.com/evostrip", purchasePath: "Amazon" },
  { category: "Precision hand tools", name: "Phoenix Contact CRIMPFOX 4 IN 1", model: "Part 1200101 ferrule tool", bestFor: "Control-panel and field wiring that calls for DIN 46228-4 ferrules.", note: "It is purpose-built for ferrules, not a replacement for a manufacturer-qualified contact crimp tool.", retailerQuery: "Phoenix Contact CRIMPFOX 4 IN 1 1200101", manufacturerUrl: "https://www.phoenixcontact.com/en-us/products/hand-tools/crimping-tools", purchasePath: "Amazon" },
...
const categoryGuides = [
  { category: "Precision hand tools" as const, title: "Make the termination right", description: "Purpose-built crimp, strip, and torque tools for repeatable termination work.", icon: Wrench, accent: "from-emerald-500/25 to-teal-500/5" },
