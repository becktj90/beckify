...
const PAGES: { href: string; label: string; description: string; icon: typeof Terminal; hue: string }[] = [
  ...
  { href: "/games", label: "Games", description: "Cosmic Cadet, Pup Planet, HexGL, Finger Runner, Toot Troopers, Booty Butt Scooter, Apollo & Rocco Run, and New Glenn Runner.", icon: Gamepad2, hue: HUES.magenta },
];
