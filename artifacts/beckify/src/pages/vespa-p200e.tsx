...
import {
  ...
  SafetyGuide,
  TopSpeedEstimate,
} from "@/components/VespaBuildGuides";
import { VespaPartsCatalog } from "@/components/VespaPartsCatalog";

type Category = "Powertrain" | "Battery" | "Electrical" | "Chassis";
type Part = readonly [Category, string, string, string, number, string | null];
const parts: readonly Part[] = [
  [
    "Powertrain",
    "QS 10-inch hub motor, 4kW 55H V3",
    "QS Motor",
    "$275.00",
    1,
    null,
  ...
  [
    "Powertrain",
    "VOTOL EM-100 controller, 72V / 100A",
    "QS Motor",
    "$130.00",
    1,
    null,
  ...
  [
    ...
    "$89.47",
    1,
    "https://www.tti.com/content/ttiinc/en/apps/part-detail.html?partsNumber=2138622-1&mfgShortname=TYC&utm=ga-shop1&channel=ppc&source=google&campaigns=tti-products",
  ],
  [
    "Battery",
    ...
    "$330.00 / case",
    2,
    "https://www.evwest.com/catalog/product_info.php?cPath=4&products_id=523",
  ],
  [
    "Battery",
    "18650 cell spacers, 10-cell",
    "Amazon",
    "$16.99",
    2,
    "https://www.amazon.com/gp/product/B08CT3XXY6/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Battery",
    "18650 insulating rings, 300 pack",
    "Amazon",
    "$8.88",
    1,
    "https://www.amazon.com/gp/product/B07H6TF58L/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Battery",
    "Pure nickel strip, 0.2 × 8mm",
    "Amazon",
    "$17.99",
    1,
    "https://www.amazon.com/gp/product/B07P3ZCJXT/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Battery",
    "84V 3A 20S lithium-ion charger",
    "Amazon",
    "$58.00",
    1,
    "https://www.amazon.com/gp/product/B07R33QHD4/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Electrical",
    "DZ47-125 2P circuit breaker",
    "Amazon",
    "$25.29",
    1,
    "https://www.amazon.com/gp/product/B07QWWPXLZ/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Electrical",
    "DROK 0–90V / 100A power meter",
    "Amazon",
    "$32.69",
    1,
    "https://www.amazon.com/gp/product/B08JB5NQ4B/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Electrical",
    "2–4 gauge quick-disconnect connector",
    "Amazon",
    "$16.99",
    1,
    "https://www.amazon.com/gp/product/B01KHQR0K4/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Electrical",
    "12V 40A automotive relay and socket",
    "Amazon",
    "$8.99",
    1,
    "https://www.amazon.com/gp/product/B074T77LPQ/ref=ppx_yo_dt_b_asin_title_o08_s00?ie=UTF8&psc=1",
  ],
  [
    "Chassis",
    "MMG 3.50-10 tubeless street tire set",
    "Amazon",
    "$68.90",
    1,
    "https://www.amazon.com/gp/product/B01N9I5TL9/ref=ppx_od_dt_b_asin_title_s00?ie=UTF8&psc=1",
  ],
  [
    "Chassis",
    "Vespa engine main bolt, M14 × 240",
    "Scooter Speed",
    "$15.99",
    1,
    "https://scooter-speed.com/vespa-engine-bolt-main-m14x240-fa-italia-c41-87500000/",
  ],
];
const img = {
...
function PartsList() {
  ...
  const rows =
    filter === "All" ? parts : parts.filter((part) => part[0] === filter);
  return (
    <section
      id="parts"
    ...
    >
      <div className="section-heading">
        <p className="section-index">07 / parts</p>
        <h2 id="parts-title">Parts list</h2>
        <p>
          Linked items use the supplied vendor URLs. Confirm compatibility,
          voltage, current, and fit before ordering.
        </p>
      </div>
      ...
      <div className="part-filter" aria-label="Filter parts">
      ...
      <div className="parts-table-wrap">
        <table>
          ...
          <tbody>
            {rows.map(([category, name, vendor, price, quantity, href]) => (
              <tr key={name}>
                <td>
                  <strong>{name}</strong>
