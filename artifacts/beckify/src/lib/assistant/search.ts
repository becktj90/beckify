...
export const ASSISTANT_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "voxel-yard", title: "Voxel Yard", description: "Mine, place, and reshape a procedurally generated island in a touch-friendly isometric voxel sandbox.", href: "/games/voxel-yard", tags: ["voxel yard", "voxel", "sandbox", "build", "mine", "block", "ipad"], concepts: ["sandbox", "building", "play"], kind: "page" },
