...
export const ASSISTANT_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "games", title: "Beckify Games", description: "Play Cosmic Cadet, Voxel Yard, HexGL, Finger Runner, and other browser games.", href: "/games", tags: ["games", "cosmic cadet", "finger runner", "space shooter", "runner", "voxel", "hexgl", "webgl"], concepts: ["arcade", "play", "webgl"], kind: "page" },
  ...
  { id: "voxel-yard", title: "Voxel Yard", description: "First-person WebGL voxel sandbox: walk a seeded continent, mine and place blocks, and fly.", href: "/games/voxel-yard", tags: ["voxel yard", "voxel", "sandbox", "build", "mine", "block", "webgl", "first person"], concepts: ["sandbox", "building", "play", "webgl"], kind: "page" },
