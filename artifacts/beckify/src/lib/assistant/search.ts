...
const PAGE_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "battery-designer", title: "Battery Designer", description: "Joe Everett’s visual pack layout tool for e-bike and custom lithium builds: cell painting, series/parallel groups, buss bars, frames, and 3D inspection. Launches from the E-Bike Build tools.", href: "/toolbox/#sec-ebike-tools", tags: ["battery designer", "pack layout", "buss bar", "cell layout", "ebike battery", "e-bike pack", "18650 layout"], concepts: ["battery", "pack layout", "e-bike", "cells"], kind: "page" },
