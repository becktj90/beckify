...
const PAGE_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "new-glenn-runner", title: "New Glenn Runner", description: "A stylized vertical launch arcade with KID, CADET, and PAD RAT difficulty, Jacklyn barge recovery, rocket pickups, and local scoring.", href: "/games/new-glenn-runner", tags: ["new glenn", "runner", "arcade", "launch", "jacklyn", "kid", "cadet", "pad rat"], concepts: ["arcade", "runner", "play"], kind: "page" },
