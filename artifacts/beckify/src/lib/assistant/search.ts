...
const PAGE_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "games", title: "Beckify Games", description: "Play New Glenn Runner, a stylized vertical launch arcade in the browser.", href: "/games", tags: ["games", "new glenn", "runner", "arcade", "launch"], concepts: ["arcade", "play"], kind: "page" },
  { id: "new-glenn-runner", title: "New Glenn Runner", description: "A stylized vertical launch arcade with KID, CADET, and PAD RAT difficulty, rocket pickups, and local scoring.", href: "/games/new-glenn-runner", tags: ["new glenn", "runner", "arcade", "launch", "kid", "cadet", "pad rat"], concepts: ["arcade", "runner", "play"], kind: "page" },
