...
const PAGE_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "games", title: "Beckify Games", description: "Play Cosmic Cadet, Pup Planet, HexGL, Finger Runner, Toot Troopers, New Glenn Runner, and other browser games.", href: "/games", tags: ["games", "cosmic cadet", "finger runner", "space shooter", "runner", "pup planet", "hexgl", "webgl", "toot troopers", "new glenn"], concepts: ["arcade", "play", "webgl"], kind: "page" },
