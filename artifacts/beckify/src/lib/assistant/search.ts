...
const PAGE_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "games", title: "Beckify Games", description: "Play New Glenn Runner, a Phaser 4 LC-36 launch arcade in the browser.", href: "/games", tags: ["games", "new glenn", "runner", "arcade", "launch"], concepts: ["arcade", "play"], kind: "page" },
  { id: "new-glenn-runner", title: "New Glenn Runner", description: "A Phaser 4 LC-36 launch arcade with KID, CADET, and PAD RAT difficulty, Jacklyn recovery, rocket pickups, and local scoring.", href: "/games/new-glenn-runner", tags: ["new glenn", "runner", "arcade", "launch", "kid", "cadet", "pad rat", "jacklyn", "phaser"], concepts: ["arcade", "runner", "play"], kind: "page" },
  { id: "gear", title: "Field Kit — Recommended Electrical Gear", description: "Curated field kits: jobsite starter, panel troubleshooting, cable fault, and bench controls — model-specific tools, not a gadget dump.", href: "/gear", tags: ["gear", "field kit", "electrical test equipment", "hand tools", "multimeter", "clamp meter", "insulation tester", "oscilloscope", "tdr", "budget tools"], concepts: ["tools", "field work", "bench work", "measurement"], kind: "reference" },
