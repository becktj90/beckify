...
export const ASSISTANT_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "games", title: "Beckify Games", description: "Play Cosmic Cadet and other browser arcade games.", href: "/games", tags: ["games", "cosmic cadet", "space shooter"], concepts: ["arcade", "play"], kind: "page" },
