...
const PAGE_DOCUMENTS: AssistantDocument[] = [
  ...
  { id: "games", title: "Beckify Games", description: "Play Kestrel Heavy, a Phaser 4 Pier 7 launch arcade in the browser. Keyboard or touch, no ads.", href: "/games", tags: ["games", "kestrel heavy", "runner", "arcade", "launch", "keyboard", "touch"], concepts: ["arcade", "play"], kind: "page" },
  { id: "kestrel-heavy", title: "Kestrel Heavy", description: "A Phaser 4 Pier 7 launch arcade with KID, CADET, and PAD RAT difficulty, Haven recovery, rocket pickups, and local scoring.", href: "/games/kestrel-heavy", tags: ["kestrel heavy", "runner", "arcade", "launch", "kid", "cadet", "pad rat", "haven", "phaser"], concepts: ["arcade", "runner", "play"], kind: "page" },
];
