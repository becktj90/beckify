...
export const TOOL_ALIASES = [
  ...
  ["conductor-length-resistance", "Conductor Length by Resistance", "Estimate length from a milliohm (mΩ) reading — end-to-end or short-to-parallel — then estimated copper or aluminum weight from density × volume.", "sec-conductor-length", "conductors", "length"],
