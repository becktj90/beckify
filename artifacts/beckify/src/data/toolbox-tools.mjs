...
export const TOOL_ALIASES = [
  ...
  ["conductor-length-resistance", "Conductor Length by Resistance", "Estimate length from a milliohm (mΩ) reading — end-to-end or short-to-parallel — with copper and aluminum temperature compensation.", "sec-conductor-length", "conductors", "length"],
