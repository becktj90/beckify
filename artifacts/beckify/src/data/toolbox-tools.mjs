...
export const TOOLS = [
  ...
  ["look-check", "Look Check", "Upload any photo for a playful look verdict plus a roast. Entertainment only — not medical or dating advice. Photos upload only when you click Analyze Look.", "sec-look-check"],
...
export const TOOL_ALIASES = [
  ...
  ["conductor-length-resistance", "Conductor Length by Resistance", "Estimate length from a milliohm (mΩ) reading — end-to-end or short-to-parallel — then estimated copper or aluminum weight from book lb/kft × one-way length.", "sec-conductor-length", "conductors", "length"],
