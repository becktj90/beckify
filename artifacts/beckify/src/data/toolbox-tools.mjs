...
export const TOOLS = [
  ...
  ["ebike-drivetrain", "E-Bike Drivetrain Calculator", "Calculate e-bike torque, RPM, sprocket ratios, wheel speed, and range. The same section also launches Battery Designer for visual pack layout.", "sec-ebike-tools"],
