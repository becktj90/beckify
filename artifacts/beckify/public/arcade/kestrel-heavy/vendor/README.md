...
Copied from the `phaser@4.2.1` npm package (`dist/phaser.min.js`). Do **not** vendor `phaser-arcade-physics` or any arcade-only split — Kestrel Heavy uses built-in Matter.
