(function () {
  ...
  function build(result) {
    ...
    if (id === 'sec-lp-optimizer' || id === 'sec-base-converter' || id === 'sec-io-list-generator' || id === 'sec-signal-scaling' || id === 'sec-ebus-budget' || id === 'sec-modbus-address' || id === 'sec-plc-timer-preset') return;
