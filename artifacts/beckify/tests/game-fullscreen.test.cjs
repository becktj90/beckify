...
assert.match(lib, /iframe\.style\.width = `\$\{width\}px`/);
assert.doesNotMatch(lib, /iframe\.style\.removeProperty\("width"\)/);
...
assert.match(host, /ARCADE_ASSET_VERSION = "kestrel-21"/);
