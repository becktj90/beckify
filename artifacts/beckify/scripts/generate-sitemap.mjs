...
const tools = [
  ...
  ["power-current-converter", "Power and Current Converter", "Convert watts, kilowatts, horsepower, amps, and kVA for common electrical systems.", "sec-power-convert"],
  ["ac-power", "AC Power Calculator", "Solve real power, reactive power, apparent power, current, and power factor for AC systems.", "sec-power-ac"],
