...
const staticRoutes = [
  ...
  ["games/apollo-rocco-run", "Apollo & Rocco Run Browser Game | Beckify", "Play Apollo & Rocco Run, an original Beckify endless-runner genre game starring Apollo and Rocco."],
